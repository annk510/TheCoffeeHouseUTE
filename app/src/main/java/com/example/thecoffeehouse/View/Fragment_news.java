...
public class Fragment_news extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        news.add(new News(R.drawable.trasua,"Giảm 50%, thèm gì gọi nhé Nhà mang tới liền",
        ...
        news.add(new News(R.drawable.news1,"Nhà mời cà phê đậm đà chỉ 12k",
        ...
        news.add(new News(R.drawable.trasua,"Nhà mời 20% PICKUP nha","Trải nghiệm nay tính năng PICKUP của Nhà với ưu đãi" +
        ...
        news.add(new News(R.drawable.trasua,"Bánh ngon Nhà mời, chỉ 19.000đ!","Cuối năm bận rộn thi cử, chạy số, chiến deadline" +
        ...
        news1.add(new News(R.drawable.trasua,"Nhà Riverside Vũ Tông Phan Hà Nội khai trương",
        ...
        news1.add(new News(R.drawable.trasua,"Taste of Xmas - Chạm vị Giáng sinh",
        ...
        news1.add(new News(R.drawable.trasua,"Bánh ngon Nhà mời, chỉ 19.000đ!","Cuối năm bận rộn thi cử, chạy số, chiến deadline" +
                " nhưng không được bỏ bữa đâu nha ấy nhé! Nhà luôn sẵn sàng giao tận nơi bánh mì nóng giòn cùng cà phê đậm đà" +
                " trà mát lạnh cho bạn nạp căng năng lượng","Order ngay"));
